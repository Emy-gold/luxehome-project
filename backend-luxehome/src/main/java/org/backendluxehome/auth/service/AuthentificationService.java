package org.backendluxehome.auth.service;
...
import org.backendluxehome.auth.dto.AuthentificationResponse;
import org.backendluxehome.auth.dto.AuthentificationRequest;
import org.backendluxehome.auth.dto.RegistrationRequest;
...
import org.backendluxehome.modules.token.repository.TokenRepository;
import org.backendluxehome.modules.user.repository.UserRepository;
import org.backendluxehome.security.service.JwtService;
...
public class AuthentificationService {
    ...
    public void activateAccount(String token) throws MessagingException {
        Token savedToken = tokenRepository.findByToken(token)
                .orElseThrow(() -> new RuntimeException("Invalic token"));
